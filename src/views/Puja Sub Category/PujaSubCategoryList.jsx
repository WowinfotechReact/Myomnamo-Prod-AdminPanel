...
import PujaSubCategoryModal from './PujaSubCategoryModal'

const PujaSubCategoryList = () => {
      ...
      return (
            <>
                  <div className="card">
                        <div className="card-body p-2 bg-white shadow-md rounded-lg" style={{ borderRadius: '10px' }}>
                              <div className="d-flex justify-content-between align-items-center mb-1">
                                    <h5 className="m-0">Puja Sub Category List</h5>
                              ...
                              <div className="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                                    ...
                                    <div className="d-flex gap-2 align-items-center">
                                          <Tooltip title="Add Puja Sub Category">
                                                <button
                                                ...
                                                >
                                                      ...
                                                      <span className="d-none d-sm-inline">Add Puja Sub Category</span>
                                                </button>
                                          </Tooltip>
                                    </div>
                                                ...
                                                <thead className="table-light  ">
                                                      ...
                                                      >
                                                            ...
                                                            <th className="text-center" style={{ whiteSpace: 'nowrap' }}>
                                                                  Puja Sub Category Name
                                                            </th>
                                                            <th className="text-center" style={{ whiteSpace: 'nowrap' }}>
                                                                  Puja Sub Category Code
                                                            </th>
                                                            <th className="text-center" style={{ whiteSpace: 'nowrap' }}>
                                                                  Owner Name
                                                            </th>
                  ...
                  {showAddUpdateModal &&
                        ...
                        <PujaSubCategoryModal show={showAddUpdateModal} onHide={(() => setShowAddUpdateModal(false))} modelRequestData={modelRequestData} setIsAddUpdateDone={setIsAddUpdateDone} />
                  }
...
export default PujaSubCategoryList
