...
import { GetBlogList } from 'services/Blog/BlogApi'
import BlogCategoryAddUpdateModal from './BlogCategoryAddUpdateModal'
...
const BlogCategoryList = () => {
      ...
      const confirmStatusChange = async (item, user) => {
            try {
                  const { blogCategoryKeyID } = item; // Destructure to access only what's needed
                  const response = await ChangeBlogCategoryStatus(blogCategoryKeyID);
      ...
      const AddLangBtnClicked = (item) => {
            ...
            navigate('/language-wise-blog-category', {
      ...
      return (
            <>
                  <div className="card">
                        <div className="card-body p-2 bg-white shadow-md rounded-lg" style={{ borderRadius: '10px' }}>
                              <div className="d-flex justify-content-between align-items-center mb-1">
                                    <h5 className="m-0">Blog Category</h5>
                              ...
                              <div className="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                                    ...
                                    <div className="d-flex gap-2 align-items-center">
                                          <Tooltip title="Add Blog Category">
                                                <button
                                                ...
                                                >
                                                      ...
                                                      <span className="d-none d-sm-inline">Add Blog Category</span>
                                                </button>
                                          </Tooltip>
                                    </div>
                                                            ...
                                                            <tr className='text-nowrap text-center' key={item.idx}>
                                                                  ...
                                                                  <td className="text-center" style={{ zIndex: 4 }}>
                                                                        <div className="d-flex justify-content-center gap-2">
                                                                              <Tooltip title="Update Blog Category">
                  ...
                  {showAddUpdateModal &&
                        ...
                        <BlogCategoryAddUpdateModal show={showAddUpdateModal} onHide={(() => setShowAddUpdateModal(false))} modelRequestData={modelRequestData} setIsAddUpdateDone={setIsAddUpdateDone} />
                  }
                  <ImagePreviewModal
                        show={showModal}
