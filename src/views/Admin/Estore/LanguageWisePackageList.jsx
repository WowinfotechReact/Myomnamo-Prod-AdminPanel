...
const LanguageWisePackageList = () => {
    ...
    const [modelRequestData, setModelRequestData] = useState({ Action: null, pSubPlanKeyID: null, moduleName: 'LanguageWiseList' })
    ...
    const GetProductSubscriptionPlanListData = async (pageNumber, searchKeywordValue) => {
        ...
        try {
            ...
            }, location?.state?.productKeyID, location?.state?.data?.pSubPlanKeyID);
    ...
    const AddBtnClicked = () => {
        ...
        setModelRequestData((prev) => ({ ...prev, Action: null, pSubPlanKeyID: location?.state?.data?.pSubPlanKeyID, pSubPlanByLangKeyID: null, productKeyID: location?.state?.productKeyID, productID: location?.state?.data?.productID }))
    ...
    const updateBtnClicked = (value) => {
        ...
        setModelRequestData((prev) => ({
            ...prev, Action: 'update',
            pSubPlanByLangKeyID: value?.pSubPlanByLangKeyID,
            pSubPlanKeyID: location?.state?.data?.pSubPlanKeyID,
...
export default LanguageWisePackageList
