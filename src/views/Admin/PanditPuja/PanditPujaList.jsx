...
const PanditPujaList = () => {
    ...
    const [pageHeading, setPageHeading] = useState("Puja")
    const [modelRequestData, setModelRequestData] = useState({ Action: null, moduleName: 'PujaList', pujaSubServiceID: null, pujaServiceID: null })
    ...
    useEffect(() => {
        ...
        if (location?.pathname === "/daily-pandit-puja") {
            ...
            setModelRequestData((prev) => ({ ...prev, pujaServiceID: pujaServiceID?.PanditPuja, pujaSubServiceID: pujaSubServiceID?.DailyPanditPuja }))
        } else if (location?.pathname === "/pandit-puja") {
            setPageHeading("Pandit Puja")
            GetPujaListData(1, null, pujaServiceID?.PanditPuja, pujaSubServiceID?.PanditPuja)
            setModelRequestData((prev) => ({ ...prev, pujaServiceID: pujaServiceID?.PanditPuja, pujaSubServiceID: pujaSubServiceID?.PanditPuja }))
        } else if (location?.pathname === "/remedy-puja") {
            setPageHeading("Remedy Puja")
            GetPujaListData(1, null, pujaServiceID?.Puja, pujaSubServiceID?.RemedyPuja)
            setModelRequestData((prev) => ({ ...prev, pujaServiceID: pujaServiceID?.Puja, pujaSubServiceID: pujaSubServiceID?.RemedyPuja }))
        } else if (location?.pathname === "/homam-puja") {
            setPageHeading("Homam Puja")
            GetPujaListData(1, null, pujaServiceID?.Puja, pujaSubServiceID?.HomamPuja)
    ...
    const handleSearchChange = (e) => {
        ...
        GetPujaListData(currentPage, value, modelRequestData?.pujaServiceID, modelRequestData?.pujaSubServiceID);
    };
            ...
            <div className="card">
                <div className="card-body p-2 bg-white shadow-md rounded-lg" style={{ borderRadius: '10px' }}>
                    <div className="d-flex justify-content-between align-items-center mb-1">
                        <h5 className="m-0">{pageHeading} List</h5>
