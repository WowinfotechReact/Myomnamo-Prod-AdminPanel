...
const LanguageWisePackage = () => {
    ...
    const [pageHeading, setPageHeading] = useState("Language wise package list")
    const [modelRequestData, setModelRequestData] = useState({ Action: null, tempPujaSubPackageKeyID: null, moduleName: 'LanguageWiseList' })
    ...
    const GetPujaSubscriptionPackageListData = async (pageNumber, searchKeywordValue) => {
        ...
        try {
            ...
            }, location?.state?.pujaKeyID, location?.state?.data?.tempPujaSubPackageKeyID);
    ...
    const AddBtnClicked = () => {
        ...
        setModelRequestData((prev) => ({ ...prev, Action: null, tempPujaSubPackageKeyID: location?.state?.data?.tempPujaSubPackageKeyID, tempPujaSubPackLangKeyID: null, pujaKeyID: location?.state?.pujaKeyID }))
    ...
    const updateBtnClicked = (value) => {
        ...
        setModelRequestData((prev) => ({
            ...prev, Action: 'update',
            tempPujaSubPackageKeyID: location?.state?.data?.tempPujaSubPackageKeyID,
            tempPujaSubPackLangKeyID: value?.tempPujaSubPackLangKeyID,
            pujaKeyID: location?.state?.pujaKeyID,
            ...
            <div className="card">
                <div className="card-body p-2 bg-white shadow-md rounded-lg" style={{ borderRadius: '10px' }}>
                    <div className="d-flex justify-content-between align-items-center mb-1">
                        ...
                        {/* Title – centered */}
                        <h5 className="m-0 text-center flex-grow-1">Language List</h5>
...
export default LanguageWisePackage
