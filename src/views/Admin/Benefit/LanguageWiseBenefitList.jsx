...
const LanguageWiseBenefitList = () => {
    ...
    const [modelRequestData, setModelRequestData] = useState({ Action: null, benefitByLangKeyID: null, moduleName: 'LanguageWiseList' })
    ...
    const GetBenefitListData = async (pageNumber, searchKeywordValue) => {
        ...
        try {
            ...
            }, location?.state?.data?.benefitKeyID);
    ...
    const ChangeStatusData = async (value) => {
        ...
        setLoader(true);
        try {
            const response = await ChangeBenefitStatus(value?.benefitKeyID, value?.appLangID);
    ...
    // ----------Other Functions------------------
    const AddBtnClicked = () => {
        setModelRequestData((prev) => ({ ...prev, Action: null, benefitKeyID: location?.state?.data?.benefitKeyID, benefitByLangKeyID: null }))
    ...
    const updateBtnClicked = (value) => {
        setModelRequestData((prev) => ({
            ...prev, Action: 'update',
            benefitByLangKeyID: value?.benefitByLangKeyID,
            appLangID: value?.appLangID,
            benefitKeyID: location?.state?.data?.benefitKeyID
        }))
        setShowAddUpdateModal(true)
    }
            ...
            <div className="card">
                <div className="card-body p-2 bg-white shadow-md rounded-lg" style={{ borderRadius: '10px' }}>
                    <div className="d-flex justify-content-between align-items-center mb-1">
                        ...
                        {/* Title – centered */}
                        <h5 className="m-0 text-center flex-grow-1"> Benefit Language List</h5>
                    ...
                    <div className="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                        ...
                        <div className="d-flex gap-2 align-items-center">
                            <Tooltip title="Add Benefit Language">
                                <button
                                    onClick={() => AddBtnClicked()}
                                ...
                                >
                                    ...
                                    <span className="d-none d-sm-inline">Add Benefit Language</span>
                                </button>
                            </Tooltip>
                        </div>
                    </div>
                                        ...
                                        <tr className='text-nowrap' key={item.idx}>
                                            ...
                                            <td className="text-center actionColSticky" style={{ zIndex: 4 }}>
                                                <div className="d-flex gap-2 justify-content-center">
                                                    <Tooltip title="Update Benefit Language ">
...
export default LanguageWiseBenefitList
