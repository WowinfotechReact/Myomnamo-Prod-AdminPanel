...
import StateAddUpdateModal from './StateAddUpdateModal'
...
const StateList = () => {
    ...
    const confirmStatusChange = async (item, user) => {
        try {
            const { stateKeyID } = item; // Destructure to access only what's needed
            const response = await ChangeStateStatus(stateKeyID);
    ...
    return (
        <>
                            ...
                            <Table striped bordered hover>
                                ...
                                <tbody>
                                    {ShopList?.map((item, idx) => {
                                        return (
                                            <tr className='text-nowrap text-center' key={item.stateKeyID}>
            ...
            {showAddUpdateModal &&
                < StateAddUpdateModal show={showAddUpdateModal} onHide={(() => setShowAddUpdateModal(false))} modelRequestData={modelRequestData} setIsAddUpdateDone={setIsAddUpdateDone} />
            }
            <StatusChangeModal
