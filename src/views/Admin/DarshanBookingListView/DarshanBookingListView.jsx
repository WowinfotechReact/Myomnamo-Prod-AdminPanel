...
import DarshanBookingOrderDetails from './DarshanBookingOrderDetails';
...
const DarshanBookingListView = () => {
  ...
  const [showDarshanBookingOrderDetails, setShowDarshanBookingOrderDetails] = useState(false);
  ...
  useEffect(() => {
    if (location?.pathname === '/DarshanBookingListView') {
  ...
  return (
    <>
                      ...
                      <td style={{ whiteSpace: 'nowrap' }} className="text-center">
                        <div className="d-flex justify-content-center gap-2">
                          <Tooltip title="Order Details">
                            <Button style={{ marginRight: '5px' }} className="btn-sm" onClick={() => setShowDarshanBookingOrderDetails(true)}>
      ...
      <DarshanBookingOrderDetails
              show={showDarshanBookingOrderDetails}
              onHide={() => setShowDarshanBookingOrderDetails(false)}
...
export default DarshanBookingListView;
